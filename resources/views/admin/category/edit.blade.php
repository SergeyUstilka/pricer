...
@section('content')
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{route('admin.product.index')}}">Товары</a></li>
            <li class="active">@if ($product->id) Редактирование @else Создание@endif товара</li>
        </ol>
    </div><!--/.row-->
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div><img src="{{asset('/storage/img/'.$product->img)}}" alt="" width="100px;"></div>
